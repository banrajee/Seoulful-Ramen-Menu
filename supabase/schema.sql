...
alter table public.item_variants add column if not exists description text;
...
insert into public.menu_items (name, description, price, category_id, image_url, status, sort_order) values
  ...
  ('Otoki Jin Ramen Mild', 'Mild Korean ramen broth.', 189, 'ramen', null, 'available', 4),
  ('Otoki Jin Ramen Spicy', 'Spicy Korean ramen broth.', 189, 'ramen', null, 'available', 5),
  ...
  ('Otoki Cheese Ramen', 'Cheesy Korean ramen.', 249, 'ramen', null, 'available', 3),
  ('Otoki Spicy Stir Fry', 'Spicy dry-style ramen.', 249, 'ramen', null, 'available', 4),
