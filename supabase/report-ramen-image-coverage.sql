...
with album_images(display_name, image_url) as (
  values
    ...
    ('Otoki Jin Chicken', '/menu-products/otoki-jin-chicken.png'),
    ...
    ('Otoki Cheese Ramen', '/menu-products/otoki-cheese-ramen.png'),
    ('Otoki Spicy Stir Fry', '/menu-products/otoki-spicy-stir-fry.png'),
